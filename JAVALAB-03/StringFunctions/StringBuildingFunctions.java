...
//backward as forward using user defined function isPalindrome().
...
//Q7. Write a Java Program for Shortening a string to a specified
//length and adds an ellipsis using user defined function truncate().

//Q8. Write a Java Program for Verifying if a string contains only
//numeric characters using user defined function isNumeric().
...
//Q10. Write a Java Program for Counting the number of words in a
...
public class StringBuildingFunctions {
 ...
 public static int countOccurrences(String mainString, String subString) {
     ...
     return (mainString.length()
             - mainString.replace(subString, "").length())
             / subString.length();
 }
