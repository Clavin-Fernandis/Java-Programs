...
//Exercises
//Develop a Java program for various String interview solutions.
...
public class StringInterviewSolutions {
 ...
 public static void main(String[] args) {
     ...
     System.out.println(alternateCharacters(
             "abc", "123"));
     System.out.println(alternateCharacters(
             "hello", "world!"));
     ...
     System.out.println(generateSubstrings(
             "abc"));
     System.out.println(generateSubstrings(
             "xy"));

     System.out.println(
             "\n10. Insert Space After Every N Characters:");
     System.out.println(
             insertSpaceAfterNChars(
 ...
 // 4. Alternate Characters
 public static String alternateCharacters(
         String s1, String s2) {
